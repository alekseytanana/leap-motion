//adapted from https://github.com/fiebrink1/wekinator_examples/blob/master/inputs/LeapMotion/LeapMotionViaProcessing/LeapMotion_Fingertips_15Inputs/LeapMotion_Fingertips_15Inputs.pde
//Sends 21 features ((x,y,z) tip of each finger) and hand positions (grab, pinch, sphere radius, roll, pitch, yaw) to Wekinator
...
numFound = 0;
  for (Hand hand : leap.getHands ()) {
    ...
    features[15] = hand_grab;
    features[16] = hand_pinch;
    features[17] = sphere_radius;
    features[18] = hand_roll;
    features[19] = hand_pitch;
    features[20] = hand_yaw;
